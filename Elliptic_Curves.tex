...
\end{lemma}
\begin{proof}
    Take any prime $\mathfrak{p}$. We saw that $E(K_{\mathfrak{p}})$ has a subgroup $A$ of finite index with $A \cong (\mathcal{O}_{K_\mathfrak{p}},+)$. In particular, $A$ is torsion-free. Hence we get \[
