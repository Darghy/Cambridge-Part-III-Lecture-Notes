...
\begin{proof}
    \begin{enumerate}[(i)]
        ...
        \item Inverses: Let $S$ be the $3^{\text{rd}}$ intersection of $T_{O_E}$ with $E$ and $Q$ the $3^{\text{rd}}$ intersection of $PS$ with $E$. Then $P \oplus Q = O_E$.
...
\begin{proof}
    ...
    \begin{itemize}
        \item It has identity $O_E$ by definition.
