...
\begin{theorem}[due to Schoen and Shlvedov]\label{theorem3.10}
    ...
    \end{align*}
    i.e. no solution $(y,(x_i)_{i=1}^5) \in A^6$ such that $y \neq x_i$ for some $i \in [5]$. Then $\left|A\right| = \exp \left(-\Omega \left(n^{1/5}\right)\right)\left|\mathbb{F}_p^n\right|$.\footnote{$\Omega$ is the opposite to $O$, one lowerboudns while the other upperbounds.}
\end{theorem}
\begin{proof}
